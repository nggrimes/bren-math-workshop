...
[Bren School of Environmental Science]{.center-text .body-text-m .blue-text}
...
[My own research in impacts from fishery insurance programs]{.gold}
...
[This will probably be a nasty calculation, but that is what computers are for. The order does not matter, only that the a corresponds to the square term, the b to the 1st degree term, and the c to the constant]{.body-text-s}
