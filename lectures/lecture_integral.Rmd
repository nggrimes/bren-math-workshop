...
# We can approximate the area by summing up easy to calculate rectangles
...
*The Integral of f(x) from x=a to x=b with respect to x*
...
# FToC means Integral=Anti-Derivative
...
.center[.bold[Sum and Difference rules]]
...
Second part says we can move multiples outside the integration to simplify. 
---
...
# Definite vs indefinte Integrals

Definite integrals have start and end values
...
Then get the area of each by solving the definite
